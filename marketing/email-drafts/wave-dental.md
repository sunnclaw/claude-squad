# Email Draft: WAVE DENTAL

**To:** wavedentaltx@gmail.com
**Clinic:** WAVE DENTAL (Houston, TX)
**Owner:** Ayham Nahhas
...
```
Quick question about missed calls at Wave Dental
```
...
I'm reaching out to Wave Dental because I've been helping dental practices recover new-patient calls that slip through during busy hours.
...
Log in `manual-email-log.csv`:
- Date sent
- Clinic: WAVE DENTAL
- Email: wavedentaltx@gmail.com
- Template: cold-outreach-1
